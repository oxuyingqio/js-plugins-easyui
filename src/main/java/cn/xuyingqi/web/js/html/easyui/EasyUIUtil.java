...
public class EasyUIUtil {
	...
	public static void downloadTheme(String theme, File localFile) {
		...
		String[] themeFiles = new String[] { easyuiURL + commonFile + theme + "/accordion.css",
				...
				easyuiURL + commonFile + theme + "/tooltip.css", easyuiURL + commonFile + theme + "/tree.css",
				easyuiURL + commonFile + theme + "/validatebox.css", easyuiURL + commonFile + theme + "/window.css",
				...
				easyuiURL + commonFile + theme + "/images/passwordbox_close.png",
				easyuiURL + commonFile + theme + "/images/passwordbox_open.png",
				...
				easyuiURL + commonFile + theme + "/images/tagbox_icons.png",
