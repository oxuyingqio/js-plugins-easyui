...
core.html.easyui.form.Textarea = (function() {
	 ...
	 * 初始化组件模板
	 * 
	 * @returns {core.html.easyui.form.Textarea}
	 */
	Constructor.prototype.init = function() {
		...
		var idLength = $("[id='" + this.id() + "']").length;
		if (idLength === 0) {
			new core.lang.Exception(this, "core.html.easyui.form.Textarea", "参数异常", "div(id:" + this.id() + ")不存在.");
		} else if (idLength > 1) {
			new core.lang.Warning(this, "core.html.easyui.form.Textarea", "参数警告", "div(id:" + this.id() + ")存在多个.");
		}
